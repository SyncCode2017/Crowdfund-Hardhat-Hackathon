...
This repository contains the implementations for the crowd-funding project.

| ----Functions -------| ------------------ Campaign ----------------- Campaign-------------------------Campaign--------|
|----------------------|--------------------start time ----------------end time --------------------decision time ends--|
| -------------------- | -----------------------| -------------------------| -------------------------------|-----------|
|----------------------|---Contract-------------| Campaign / funding ------|---- Time to decide whether-----|Milestones-|
|----------------------|-initilisation period---|----round period----------|----campaign was successful ----|-----------|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
| setAllowedToken -----|----- `Only MOAT`- -----|------- `Only MOAT`- -----|----- `Only MOAT`- -------------|`Only MOAT`|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
| setNftPerkContracts -|----- `Only MOAT`- -----|------- `Only MOAT`- -----|----- `Only MOAT`- -------------|`Only MOAT`|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
| setTreasuryAddress --|----- `Only MOAT`- -----|------- `Only MOAT`- -----|----- `Only MOAT`- -------------|`Only MOAT`|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
| setBusinessAddress --|----- `Only MOAT`- -----|------- `Only MOAT`- -----|----- `Only MOAT`- -------------|`Only MOAT`|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
|setFundingTiers&Costs |----- `Only MOAT`- -----|------- ------------ -----|----- ------------ -------------|-----------|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
| setTargetAmounts ----|----- `Only MOAT`- -----|------- `Only MOAT`- -----|----- `Only MOAT`- -------------|-----------|
| -------------------- | ---------------------- | ------------------------ | ------------------------------ |-----------|
...
- [Jira](ADD_WHEN_AVAILABLE)
- [Proposal](ADD_WHEN_AVAILABLE)
- [Slack](ADD_WHEN_AVAILABLE)
- [Wiki](ADD_WHEN_AVAILABLE)
- [Drive](ADD_WHEN_AVAILABLE)
- [Linting](ADD_WHEN_AVAILABLE)
